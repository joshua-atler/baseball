...
class Consts {
    ...
    static teamColors = {
        'AL': [
            [
                'rgb(255, 255, 255)', 'rgb(223, 70, 1)', 'rgb(189, 48, 57)', 'rgb(143, 188, 230)', 'rgb(19, 74, 142)',
            ],
            [
                'rgb(229, 0, 34)', 'rgb(189, 155, 96)', 'rgb(250, 70, 22)', 'rgb(0, 43, 92)', 'rgb(196, 206, 212)',
            ],
            [
                'rgb(0, 50, 120)', 'rgb(235, 110, 31)', 'rgb(186, 0, 33)', 'rgb(0, 92, 92)', 'rgb(239, 178, 30)',
            ]
        ],
        'NL': [
            [
                'rgb(19, 39, 79)', 'rgb(232, 24, 40)', 'rgb(0, 45, 114)', 'rgb(171, 0, 3)', 'rgb(0, 163, 224)',
            ],
            [
                'rgb(18, 40, 75)', 'rgb(14, 51, 134)', 'rgb(198, 1, 31)', 'rgb(196, 30, 58)', 'rgb(253, 184, 39)',
            ],
            [
                'rgb(0, 90, 156)', 'rgb(255, 196, 37)', 'rgb(253, 90, 30)', 'rgb(167, 25, 48)', 'rgb(51, 51, 102)',
            ]
        ]
    };
